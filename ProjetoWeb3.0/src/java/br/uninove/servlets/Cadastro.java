...
public class Cadastro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String adm = request.getParameter("false");
        ...
        dao.Cadastrar(user);    
            ...
            out.println("<div class=\"container-cadastro100-form-btn\">\n" +
"                            <button class=\"cadastro100-form-btn\">\n" +
"                                <li><a href=\"login.jsp\">Voltar para a tela de login</a></li>\n" +
"                                        \n" +
"                            </button>\n" +
"                        </div>");
